    ...
    try {
      ...
      for (Field blockField : Blocks.class.getDeclaredFields()) {
        if (Block.class.isAssignableFrom(blockField.getType())) {
          Block block = (Block)blockField.get((Object)null);
          if (block == toReplace) {
            ...
            blockField.set((Object)null, newBlock);
            ItemBlock itemBlock = itemBlockClass.getConstructor(new Class[] { Block.class }).newInstance(new Object[] { newBlock });
            ...
            classTest[0] = blockField.get((Object)null).getClass();
